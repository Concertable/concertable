...
api/Modules/<ModuleName>/
  Concertable.<Module>.Contracts/
  Concertable.<Module>.Domain/
  Concertable.<Module>.Application/
  Concertable.<Module>.Infrastructure/
  Concertable.<Module>.Api/
  Tests/
    Concertable.<Module>.UnitTests/
    Concertable.<Module>.IntegrationTests/
```
